...
const data = {
  ...
  rows: [
    ...
    },
    {
      ...
      content: `Cocktail attire! The ceremony will take place outside behind the venue, and there will be a grassy area with a fire pit and where games will be available. However, as the long goes on and the lights start to dim feel free to loosen those buttons and lose those ties/heels!`
    },
    {
